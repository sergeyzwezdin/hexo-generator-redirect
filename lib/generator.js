...
const generator = (locals) => {
  return ({ posts, pages }) => {
     ...
     * @type {string}
     */
    let layoutName = locals.config.redirect.layout || 'hexo-generator-redirect'; // redirect layout name
